...
const toCelsius = (temp: number) => Math.round(temp - 273.15); // Convert Kelvin to Celsius
...
export const getIcon = async () => {
	...
	const icon = new URL(
		`../assets/icons/weather/${iconTheme}/${weather ? weather : "unknown"}.png`,
		import.meta.url,
	).href;
